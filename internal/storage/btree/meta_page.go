...
// メタページのレイアウト:
//   - offset 0-7:   SlottedPage ヘッダー (Page LSN 等)
...
func createMetaPage(data []byte) *metaPage {
	node.NewSlottedPage(data).Initialize()
