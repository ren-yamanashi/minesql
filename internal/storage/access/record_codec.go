...
func encodeRecordNonKeyPrefix(lastModified TrxId, rollPtr UndoPtr) []byte {
...
func decodeRecordNonKey(nonKeyBytes []byte) (lastModified TrxId, rollPtr UndoPtr, nonKeyColumns []byte) {
