...
func TestConstraintMetaRecordFileId(t *testing.T) {
	t.Run("コンストラクタで指定した FileId を返す", func(t *testing.T) {
		// GIVEN
		cr := NewConstraintMetaRecord(page.FileId(1), "id", "PRIMARY", page.FileId(0), "")
...
func TestConstraintMetaRecordColumnName(t *testing.T) {
	t.Run("コンストラクタで指定したカラム名を返す", func(t *testing.T) {
		// GIVEN
		cr := NewConstraintMetaRecord(page.FileId(1), "user_id", "fk_user", page.FileId(2), "id")
...
func TestConstraintMetaRecordConstraintName(t *testing.T) {
...
func TestConstraintMetaRecordReferenceTableFileId(t *testing.T) {
	t.Run("コンストラクタで指定した参照先テーブルの FileId を返す", func(t *testing.T) {
		// GIVEN
		cr := NewConstraintMetaRecord(page.FileId(2), "user_id", "fk_user", page.FileId(5), "id")
...
func TestConstraintMetaRecordReferenceColumnName(t *testing.T) {
...
func TestConstraintMetaRecordEncode(t *testing.T) {
	...
	t.Run("主キー制約をエンコード・デコードできる", func(t *testing.T) {
		// GIVEN
		original := NewConstraintMetaRecord(page.FileId(1), "id", "PRIMARY", page.FileId(0), "")
	...
	t.Run("外部キー制約をエンコード・デコードできる", func(t *testing.T) {
		// GIVEN
		original := NewConstraintMetaRecord(page.FileId(2), "user_id", "fk_orders_users", page.FileId(1), "id")
	...
	t.Run("ユニークキー制約をエンコード・デコードできる", func(t *testing.T) {
		// GIVEN
		original := NewConstraintMetaRecord(page.FileId(1), "email", "idx_email", page.FileId(0), "")
	...
	t.Run("FileId が 0 の場合も正しくエンコード・デコードできる", func(t *testing.T) {
		// GIVEN
		original := NewConstraintMetaRecord(page.FileId(0), "col", "pk", page.FileId(0), "")
...
func TestDecodeConstraintMetaRecord(t *testing.T) {
	t.Run("エンコード済みレコードから FileId とカラム名と制約名を復元できる", func(t *testing.T) {
		// GIVEN
		cr := NewConstraintMetaRecord(page.FileId(42), "name", "uq_name", page.FileId(0), "")
		record := cr.Encode()
	...
	t.Run("エンコード済みレコードから参照先テーブルとカラムを復元できる", func(t *testing.T) {
		// GIVEN
		cr := NewConstraintMetaRecord(page.FileId(3), "dept_id", "fk_dept", page.FileId(5), "id")
		record := cr.Encode()
