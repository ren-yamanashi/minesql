...
- ディスクは、[バッファプール](../buffer/buffer-pool.md)から依頼された通りに[ページ](./page.md)を永続化 (読み書き) する
  - [PageId](./page.md#pageid) を受け取り、ページ単位でデータを読み書きする
...
- 指定された [PageId](./page.md#pageid) に対応するページからデータを読み込む
...
- 指定された [PageId](./page.md#pageid) に対応するページにデータを書き込む
