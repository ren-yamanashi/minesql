...
- 参照
  - [リーフノードへの挿入](./node/leaf-node.md#レコードの挿入)
  - [ブランチノードへの挿入](./node/branch-node.md#レコードを挿入)

## レコード削除

- 参照
  - [リーフノードのレコード削除](./node/leaf-node.md#レコードの削除)
  - [ブランチノードのアンダーフロー処理](./node/branch-node.md#アンダーフロー処理)
